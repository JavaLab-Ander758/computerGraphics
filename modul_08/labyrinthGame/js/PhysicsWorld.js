...
export class PhysicsWorld {
	...
	setup(_gravityAcceleration) {
		...
		this.physicsWorld.setGravity(new Ammo.btVector3(0, _gravityAcceleration, 0));
	...
	_addRigidBody(rigidBodyCompound, colGroup, group) {
		this.physicsWorld.addRigidBody(rigidBodyCompound, colGroup, group);
	}
