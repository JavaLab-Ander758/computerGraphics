...
import { SceneUtils } from '../../../../lib/three/examples/jsm/utils/SceneUtils.js';
...
export function main() {
    ...
    renderer.shadowMapEnabled = true; //NB! For skygge.
...
function addModels() {
    ...
    let mPlane = new THREE.MeshLambertMaterial({ color: 0xFFFFFF, side: THREE.DoubleSide, wireframe: true, wireframe_linewidth: 1 });
    ...
    let mCubeMat1 = new THREE.MeshBasicMaterial({ color: 0x000000, wireframe: true, wireframe_linewidth: 1 });
...
function addHeartShapeModel() {
	...
	let extrudeSettings = { amount: 100, bevelEnabled: true, bevelSegments: 2, steps: 2, bevelSize: 1, bevelThickness: 1 };
...
function addOddShapeModel() {
    ...
    let mShape = new THREE.MeshBasicMaterial({ color: 0x000000, wireframe: true, wireframe_linewidth: 10 });
...
function createPolyhedron() {
	...
	let mPolyWireframe = new THREE.MeshBasicMaterial({ color: 0x000000, wireframe: true, wireframe_linewidth: 10 });
