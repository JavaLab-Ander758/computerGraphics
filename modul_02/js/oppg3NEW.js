...
function initBuffers() {
    ...
    vertexBufferCube.numberOfItems = cubeVertices.length; // NB!!
    ...
    vertexBufferCoord.numberOfItems = coordVertices.length / vertexBufferCoord.itemSize; 	// NB!!
...
function draw() {
    ...
    modelMatrix.setTranslate(6, 0, 8);
